...
<body
	...
	<img src="D:\project\vuproject\WebContent\img\concavetech1.png"
		height="50px" width="50px" alt=""
		class="brand-gui ml-2 d-none d-sm-block p-2">
		...
		<li class="nav-item dropdown"><a class="nav-link"
			...
			<div class="dropdown-menu dropdown-menu-right">
				...
				<a class="dropdown-item"
					href="<%=request.getContextPath()%>/jspPage/updateProfile.jsp"><i
					class="fa fa-user"></i> Profile</a> <a class="dropdown-item"
	...
	<div class="app-body">
		<div class="sidebar">
			...
			<ul class="nav">
				<li class="nav-item"><a class="nav-link"
					href="<%=request.getContextPath()%>/jspPage/home.jsp""><i
						class="fa fa-home"></i> Home</a></li>
				<li class="nav-item"><a class="nav-link"
					href="<%=request.getContextPath()%>/jspPage/dashBoard.jsp"><i
						class="fa fa-tachometer-alt"></i> Dashboard</a></li>
				<li class="nav-item nav-dropdown"><a
					class="nav-link nav-dropdown-toggle" href="#"><i
						class="fa fa-address-card"></i> Views</a>
					<ul class="nav-dropdown-items">
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/ProjectViewServlet"><i
								class="fa fa-paper-plane ml-2"></i> Project's View</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/UserViewServlet"><i
								class="fa fa-user ml-2"></i> User`s Views</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/TaskViewServlet"><i
								class="fa fa-tasks fa_custom fa-2x"></i> Task`s Views</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/jspPage/costView.jsp"><i
								class="fa fa-user ml-2"></i> Cost`s Views</a></li>
					</ul>
				<li class="nav-item nav-dropdown"><a
					class="nav-link nav-dropdown-toggle" href="#"><i
						class="fa fa-address-card"></i> Update</a>
					<ul class="nav-dropdown-items">
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/UpdateProjectServlet"><i
								class="fa fa-puzzle-piece"></i> Update Project</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/UpdateTaskServlet"><i
								class="fa fa-tasks fa_custom fa-2x"></i> Update Task</a></li>
					</ul></li>
				...
				<li class="nav-item nav-dropdown"><a
					...
					<ul class="nav-dropdown-items">
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/new-project"><i
								class="fa fa-plus ml-2"></i> New Project</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/NewTask"><i
								class="fa fa-plus ml-2"></i> New Task</a></li>
					</ul></li>
				<li class="nav-item nav-dropdown"><a
					class="nav-link nav-dropdown-toggle" href="#"><i
					...
					<ul class="nav-dropdown-items">
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>//SignUpServlet"><i
								class="fa fa-user-plus ml-2"></i> Create New User</a></li>
					</ul></li>
				<li class="divider"></li>
		...
		<!-- Main content -->
		<main class="main"> <!-- Breadcrumb --> </main>
