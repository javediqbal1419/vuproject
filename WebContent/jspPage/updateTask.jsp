...
<head>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/mycss/mycss.css" type="text/css">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
                                    ...
                                    <div class="card mx-2">
                                        <div class="card-body">
                                            ...
                                            <div class="smallbox" align="right">
                                                ...
                                                <button type="button" data-whatever="${task.taskId }" class="btn btn-link text-right lead text-danger" data-toggle="modal" data-target="#exampleModal">
                                            ...
                                            <div>
                                                ...
                                                <progress class="progressbar" name="${task.taskId}" id="more${task.taskId}" max="90" value="${task.taskPercent}"></progress>

                                                <button class="perbtn_p" type="button" onclick="updateMoreProgress('more${task.taskId}')" id="more${task.taskId}" name="more${task.taskId}" >+</button>
                                            </div>
    ...
    <script>
     ...
     function updateMoreProgress(taskId)
        {
        	
        //	alert(taskId);
        	var res =document.getElementById(taskId).value;
        //	alert('res'+ res);
        $(taskId).val(res + 10);
